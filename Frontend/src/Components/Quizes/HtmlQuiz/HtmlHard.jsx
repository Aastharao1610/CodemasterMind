  ...
  const questions = [
    {
      ...
      options: ['charset', 'encoding', 'meta', ' doctype'],
      correctAnswer: 'charset',
    },
    
    {
      question:'Which HTML attribute is used to specify whether an input field should be required to be filled out before submitting the form?',
      options:['required',' validate',' mandatory','validate'],
      correctAnswer:'required'
    },
   
    {
      question:'What does the defer attribute do when added to a <script> tag in HTML?',
      options:['Delays the loading of the script until after the page content has been parsed',
      'Prevents the script from executing',
      ' Executes the script asynchronously',
      'Loads the script only when the user interacts with the page'],
      correctAnswer:'Delays the loading of the script until after the page content has been parsed'
    },
   

    {
      question:'What is the purpose of the HTML <figure> and <figcaption> elements?',
      options:[`To define a figure and its caption',
      ' To define a container for images',
      'To create a floating image with a caption',
      'To define a caption for an image or a table`],  
      correctAnswer: 'To define a figure and  its caption'
    },
    {
  ...
  return (
    ...
    <QuizLayout>
      ...
      <div className="max-w-lg mx-auto overflow-y-auto pt-10">
        <h1 className="text-3xl font-bold mb-6 text-center">HTML Hard Quiz</h1>
