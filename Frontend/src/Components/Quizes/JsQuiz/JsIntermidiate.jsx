...
const JsInterview = () => {
  const questions = [
    ...
    {
      question:'Which tag is used to define an anchor or hyperlink in Js?',
      options:[' <a>','<h>','<p>','<link>'],
      correctAnswer:'<a>'
    },
    {
      question:'What is the default file extension for an Js file?',
      options:[' .Js','.htm',' .web','.xml'],
      correctAnswer:'.Js'
    },
    {
      question:'How can you create an ordered list in Js?',
      options:[' <ol>','<ul>','<li>','<list>'],
      correctAnswer:'<ol>'
    },
    {
      question:'Which tag is used to insert a line break in Js?',
      options:[' <lb>','<br>','<linebreak>','<Break>'],
      correctAnswer:'<br>'
    },
    {
      question:'In Js, what does the acronym DOCTYPE stand for?',
      options:['Document Type ','Document Type Declaration','Document Text','Document Table'],
      correctAnswer:'Document Type Declaration'
    },
    {
      question:'Which attribute is used to define inline styles in Js?',
      options:[' class','style','font','css'],
      correctAnswer:'style'
    },
    {
      question:'How can you create a comment in Js?',
      options:[' <!-- This is a comment -->','// This is a comment','This is a comment','/* This is a comment */'],
      correctAnswer:'<!-- This is a comment -->'
    },
    {
      question:'Which tag is used to define the header of a table in Js?',
      options:[' <th>','<head>','<header>','<td>'],
      correctAnswer:'<header>'
    },
    {
      question:'What is the purpose of the alt attribute in an Js image tag?',
    ...
    {
      question:'Which tag is used to create an unordered list in Js?',
      options:[' <ol>','<ul>','<li>','<list>'],
      correctAnswer:'<ul>'
    },
    {
    ...
    {
      question:'What is the purpose of the colspan attribute in an Js table?',
    ...
    {
      question:'What is the purpose of the meta tag in Js?',
      options:[' To create a clickable area on an image map','To define metadata about an Js document','To set the character encoding of the document','To style the text within a document'],
      correctAnswer:'To define metadata about an Js document'
    },
    {
      question:'Which Js tag is used to define the body of the document?',
    ...
    {
      question:'Which Js tag is used to create a hyperlink?',
    ...
    {
      question:'Which tag is used to define a paragraph in Js?',
    ...
    {
      question:'How can you make text bold in Js?',
      options:[' <Strong>Bold Text</Strong','<bold>Bold Text</bold>','<b>Bold Text</b>','<i>Bold Text</i>'],
      correctAnswer:'<b>Bold Text</b>'
    },
    {
      question:'Which tag is used to insert an image in Js?',
      options:[' <img>','<image>','<insert>','<Picture>'],
      correctAnswer:'<img>'
    },
    {
      question:'What is the purpose of the <figcaption> element in Js?',
    ...
    {
      question:' Which attribute is used to define the source URL of an embedded video in Js?',
    ...
    {
      question:'Which Js element is used to define a subscripted text?',
      options:[' <sub>','<Subscript>','<sup>','<below>'],
      correctAnswer:'<sub>'
    },
    {
      question:'What is the purpose of the <cite> element in Js?',
      options:[' Create a circle',"Define a citation","Set the document's title",'Define a code block'],
      correctAnswer:'Define a citation'
    },
    {
      question:' Which attribute is used to specify the alignment of text within a table cell in Js?',
      options:['align','text-align','cell-align','align-text'],
      correctAnswer:'text-align'
    },
    {
      question:'How can you create a button in Js?',
      options:['<btn>,<button>','<imput type="button">','<create-button>'],
      correctAnswer:'<button>'
    },
    {
      question:'Which Js element is used for grouping and applying styles to inline elements?',
      options:[' <group>','<span>','<div>','<section>'],
      correctAnswer:'<span>'
    },
    {
      question:'What does the <mark> element in Js represent?',
      options:['Highlighted text','A marked section',' A navigation link',' A code block '],
      correctAnswer:'Highlighted text'
    },
    {
      question:' How do you create a text area in Js?',
      options:[' <textarea>','<input type="textarea">','<text>','<ipnutarea>'],
      correctAnswer:'<textarea>'
    },
    {
      question:'Which attribute is used to specify the maximum value of an input element in Js?',
      options:['maximum','max',' value-max',' input-max'],
      correctAnswer:'max'
    },
    {
      question:'What is the purpose of the <datalist> element in Js?',
    ...
    {
      question:'How can you make a text italic in Js?',
      options:['<i> ',
      '<italic>',
      '<em>',
      '<italics>' ],
    ...
    {
      question:'What is the purpose of the <progress> element in Js?',
    ...
    {
      question:' What is the purpose of the <aside> element in Js?',
      options:[' Define a list of data items for an input element',
      ' Create an alert',
    ...
    {
      question:'How do you create a radio button in Js?',
    ...
    {
      question:'Which Js element is used to define a footer in a document?',
      options:[' <footer>',
      '<end>',
      '<bottom>',
      '<last>' ],
    ...
    {
      question:' How do you create a checkbox in Js?',
    ...
    {
      question:'Which Js element is used to define a section in a document?',
      options:[' <div>',
      '<section>',
      '<area>',
      '<article>' ],
    ...
    {
      question:'What is the purpose of the <abbr> element in Js?',
  ...
  return (
    ...
    <QuizLayout>
      ...
      <div className="max-w-lg mx-auto overflow-y-auto pt-10">
        <h1 className="text-3xl font-bold mb-6 text-center">Js Intermediate Quiz</h1>
